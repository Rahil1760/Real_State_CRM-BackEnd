  ...
  try {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      const prop = new Property({
        ...
        s3Urls: {
          brochure: `https://aurahome-mock-s3.s3.amazonaws.com/brochures/brochure_rahil_${i + 1}.pdf`,
          floorPlan: `https://aurahome-mock-s3.s3.amazonaws.com/floorplans/floorplan_rahil_${i + 1}.png`
        },
    ...
    for (let i = 0; i < 3; i++) {
      ...
      const prop = new Property({
        ...
        s3Urls: {
          brochure: `https://aurahome-mock-s3.s3.amazonaws.com/brochures/brochure_orchid_${i + 1}.pdf`,
          floorPlan: `https://aurahome-mock-s3.s3.amazonaws.com/floorplans/floorplan_orchid_${i + 1}.png`
        },
